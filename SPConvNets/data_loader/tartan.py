'''
Source: DROID-SLAM https://github.com/princeton-vl/DROID-SLAM/blob/main/droid_slam/data_readers/tartan.py
'''
...
class TartanAirDataLoader(RGBDDataset):
    ...
    def __init__(self, mode='training', **kwargs):
        self.mode = mode
        self.n_frames = 2
        super(TartanAirDataLoader, self).__init__(name='TartanAir', **kwargs)
    ...
    def _build_dataset(self):
        ...
        for scene in tqdm(sorted(scenes)):
            ...
            poses[:,:3] /= TartanAirDataLoader.DEPTH_SCALE
            intrinsics = [TartanAirDataLoader.calib_read()] * len(images)
    ...
    def depth_read(depth_file):
        depth = np.load(depth_file) / TartanAirDataLoader.DEPTH_SCALE
